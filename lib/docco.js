(function() {
  var destination, docco_styles, docco_template, ensure_directory, exec, ext, fs, generate_documentation, generate_html, get_language, highlight, highlight_end, highlight_start, l, languages, parse, parseArgs, path, showdown, spawn, template, _ref;
  ...
  parseArgs(function(sources, relativeRoot) {
    var context;
    context = {
      sources: sources,
