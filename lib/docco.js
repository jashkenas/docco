(function() {
  var destination, docco_styles, docco_template, ensure_directory, exec, ext, fs, generate_documentation, generate_html, get_language, highlight, highlight_end, highlight_start, l, languages, parse, path, showdown, sources, spawn, tags, template, _ref;
  ...
  parse = function(source, code) {
    var code_text, docs_text, has_code, ignoreValue, index, language, line, lines, save, section, sections, _i, _len;
    lines = code.split('\n');
    sections = [];
    ...
    sections = (function() {
      var _len2, _results;
      _results = [];
      for (index = 0, _len2 = sections.length; index < _len2; index++) {
        section = sections[index];
        if (!section.docs_text.match(ignoreValue)) _results.push(section);
      }
      return _results;
    })();
    return sections;
