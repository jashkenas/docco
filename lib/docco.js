(function() {
  var destination, docco_full_styles, docco_fullscreen_template, docco_styles, docco_template, ensure_directory, exec, ext, fs, generate_documentation, generate_html, get_language, highlight, highlight_end, highlight_start, l, languages, parse, path, showdown, sources, spawn, template, _ref;
  ...
  docco_full_styles = fs.readFileSync(__dirname + '/../resources/docco_full.css').toString();
  ...
  if (sources.length) {
    ensure_directory('docs', function() {
      ...
      fs.writeFile('docs/docco_full.css', docco_full_styles);
