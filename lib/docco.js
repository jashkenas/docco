(function() {
  ...
  docco_template = template(fs.readFileSync((typeof process !== "undefined" && process !== null ? process.CMD.argv.template : void 0) || __dirname + '/../resources/docco.jst').toString());

  docco_styles = fs.readFileSync((typeof process !== "undefined" && process !== null ? process.CMD.argv.style : void 0) || __dirname + '/../resources/docco.css').toString();
