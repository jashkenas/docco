...
(function() {
  ...
  write = function(source, sections, config) {
    ...
    destination = function(file) {
      var filename;
      filename = (config.keepext && path.basename(file)) || path.basename(file, path.extname(file));
