...
(function() {
  var Docco, commander, config, configure, document, exec, ext, format, fs, getLanguage, highlight, highlightEnd, highlightStart, l, languages, marked, parse, path, run, spawn, version, write, _, _ref,
    __slice = [].slice;
