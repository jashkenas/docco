...
(function() {
  var Docco, _, buildMatchers, commander, configure, defaults, document, format, fs, getCSSPath, getDestinationInformation, getInformationOnFiles, getLanguage, getRelativePath, getSourceInformation, glob, highlightjs, languages, marked, parse, path, run, version, write;
  ...
  getSourceInformation = function(file, rootDirectory) {
    var source;
  ...
  getDestinationInformation = function(language, source, rootDirectory, targetDirectory, flatten) {
    var destination;
    destination = {};
    console.log(`SourcE: ${JSON.stringify(source)}, ${JSON.stringify(rootDirectory)}, ${JSON.stringify(targetDirectory)}, ${JSON.stringify(flatten)})`);
  ...
  getInformationOnFiles = function(config) {
    var destination, destinationFileInformation, destinations, file, informationOnFiles, j, k, language, len, len1, len2, m, other, others, ref, ref1, ref2, rootDirectory, source, sourceDirectory, sourceFileInformation, target, targetDirectory;
  ...
  Docco = module.exports = {run, document, parse, format, version, languages, getDestinationInformation, getLanguage, getInformationOnFiles, getCSSPath, getRelativePath};
