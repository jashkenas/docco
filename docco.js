...
(function() {
  var Docco, commander, configure, defaults, document, exec, ext, fs, getLanguage, highlight, highlightEnd, highlightStart, htmlEscape, l, languages, marked, parse, path, run, spawn, version, writeHtml, _, _ref,
    __slice = [].slice;
