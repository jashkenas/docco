...
(function() {
  var Docco, commander, config, configure, document, ext, format, fs, getLanguage, highlight, l, languages, marked, parse, path, run, version, wrench, write, _,
    __slice = [].slice;

  document = function() {
    var cssContents, cssName, cssOutput, files, nextFile;
    ...
    if (fs.existsSync(config["public"])) {
      wrench.copyDirSyncRecursive(config["public"], config.output, {
        preserve: true
      });
    }
