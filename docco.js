...
(function() {
  var Docco, commander, config, configure, document, ext, format, fs, getLanguage, highlight, highlightAuto, highlighter, l, languages, marked, parse, path, run, version, write, _,
    __slice = [].slice;
