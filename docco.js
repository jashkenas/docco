...
(function() {
  var Docco, commander, config, configure, document, ext, format, fs, getLanguage, highlighter, highlight, highlightAuto, l, languages, marked, parse, path, run, version, write, _,
    __slice = [].slice;
  ...
  marked.setOptions({
    highlight: function(code, lang) {
        if (!lang){ return highlightAuto(code).value; }
        var ext = '.' + lang;
        languages[ext] && (lang = languages[ext].name);
