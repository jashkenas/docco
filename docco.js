...
(function() {
  var Docco, commander, configure, defaults, document, ext, format, fs, getLanguage, highlight, l, languages, marked, outputCode, parse, path, run, version, write, _,
    __slice = [].slice;

  document = function(options, callback) {
    var complete, config, copyAsset, files, nextFile;
