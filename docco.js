...
(function() {
  ...
  document = function(options, callback) {
    ...
    return fs.mkdirs(config.output, function() {
      ...
      if (config.source) {
        return fs.mkdirs(config.source, nextFile);
      } else {
        return nextFile();
      }
    });
