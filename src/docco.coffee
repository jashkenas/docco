...
docco_template  = template fs.readFileSync(process?.CMD.argv.template || __dirname + '/../resources/docco.jst').toString()

# The CSS styles we'd like to apply to the documentation.
docco_styles    = fs.readFileSync(process?.CMD.argv.style || __dirname + '/../resources/docco.css').toString()
